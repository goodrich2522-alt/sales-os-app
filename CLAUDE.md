...
- **รูปตรวจรถบังคับ 6 ช่อง** — ผู้รับ/ผู้ส่งรถต้องถ่าย name plate, เอกสาร PI, รถ 4 มุม ครบก่อนยืนยัน · เก็บใน `inspections.image_slots` (jsonb — migration รันแล้ว 13 ก.ค. 2026 ✅) + `images` เก็บรวมเหมือนเดิมเพื่อ backward compat · หน้าเซลล์โชว์ป้ายกำกับช่อง
