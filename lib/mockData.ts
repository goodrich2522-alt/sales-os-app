...
export const DEFAULT_STOCK_STATUSES = ["พร้อมขาย", "ติดจอง (รอโอนมัดจำ)", "มัดจำแล้ว/เงินสด", "มัดจำแล้ว/ไฟแนนซ์", "ปิดการขายแล้ว", "สั่งผลิต", "รอตรวจสอบสต็อก", "รถเช่า", "เคลม/รับกลับ"];
